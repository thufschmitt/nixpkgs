{ stdenv, fetchFromGitHub, ocaml, findlib, menhir, yojson, ulex, pprint, fix, functory, ocamlbuild }:
...
stdenv.mkDerivation {
  ...
  buildInputs = [ ocaml findlib yojson menhir ulex pprint fix functory ocamlbuild ];
